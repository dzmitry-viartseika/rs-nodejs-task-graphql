...
import { getMemberTypeByIdResolver, getMemberTypesResolver, getPostByIdResolver, getPostsResolver, getProfileByIdResolver, getProfilesResolver, getUserByIdResolver, getUsersResolver, } from './resolvers/rootResolvers.js';
...
const allQueryFields = {
    users: {
        ...
        resolve: async (_source, _args, context, resolveInfo) => await getUsersResolver(context, resolveInfo),
    },
    posts: {
...
const getByIdQueryFields = {
    ...
    memberType: {
        ...
        resolve: async (_source, args, context) => await getMemberTypeByIdResolver(args, context),
    },
    profile: {
        type: profileType,
        args: {
        ...
        resolve: async (_source, args, context) => await getProfileByIdResolver(args, context),
    },
};
